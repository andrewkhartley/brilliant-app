...
return [
    ...
    'review' => [
        ...
        'summary' => [
            ...
            'ticketBody' => 'The route is calculated as a sequence of moving worlds: each leg includes a burn profile, a cruise or flip segment, and the orbit time needed before the next departure.',
            ...
            'dilationNoteTitle' => 'A small relativistic souvenir',
            'dilationNoteBody' => 'During this itinerary, the traveler experiences :seconds fewer seconds than clocks back home: roughly :minutes minutes younger by arrival.',
        ],
        'itinerary' => [
            'heading' => 'Itinerary',
