...
return [
    ...
    'intro' => 'I want to show a bit of what I\'m working on so that you can see where I intend to go. I keep coming back to the same question from different directions: how do we use technology to help curious people think more clearly, organize what matters, and turn inspiration into something they can build with other people?',
    'alexandria' => [
        'kicker' => 'Alexandria',
        ...
        'bodyA' => 'I needed something that started at the idea and could route them to whatever structure the writer needs. Alexandria lets writers and worldbuilders capture unstructured ideas as they arrive, then progressively organize them as the underlying world takes shape.',
        'bodyB' => 'The system is built on user-defined schemas, so the tool adapts to the work and enrich the way the data is navigated. Its AI layer reads each user\'s structure before proposing content, which uses tech to assist, but ensures the integrity of someone\'s voice.',
        'bodyC' => 'Be smart with technology while staying human. Do not replace creative judgment. Give yourself an environment that gives you power of your own ideas.',
        'features' => [
            'schema' => [
    ...
    'note' => 'For Brilliant, the connection is straightforward: I want to contribute as an engineer now, while continuing to build toward the kind of learning community that makes curiosity feel kinetic.',
];
