 ...
 * - Two primary links: Playground (/playground), About (/about)
 *
 * Layout:
 ...
 *   lang/en/nav.php (nav.playground, nav.about); brand mark and aria-label in
 ...
 *
 * Link destinations: /playground and /about don't have controllers yet
 * (Phases 9 and 12). The links exist so the chrome shape is right; their
 * destinations come online in their respective phases. Acceptable v1
 * behavior is a 404 from those links.
 */
export function Nav() {
